...
@section('main')
    ...
    <div class='px-12 py-5 text-sm'>
        <h1 class='text-xl mb-6'>Roles</h1>
            ...
            <tbody>
                @foreach($roles as $role)
                    <tr class='border-b h-4'>
                        <td class='px-8 py-2'>{{$role->id}}</td>
                        <td class='px-8 py-2'>{{$role->name}}</td>
                        <td class='px-8 py-2'>{{$role->created_at}}</td>
                        <td class='px-8 py-2'>{{$role->updated_at}}</td>
