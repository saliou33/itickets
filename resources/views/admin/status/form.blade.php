...
@section('main')
    ...
    <div class='px-12 py-3 text-sm'>
        ...
        <form method="POST" action="/admin/status"  class='flex flex-col gap-3'>
            @method('PATCH')
            @csrf
            ...
            <div class='flex flex-col gap-2'>
                ...
                <div>
                    <input type="name" id="name" name="name" class='w-full p-2 outline-none rounded-sm border'  value="{{$status->name}}" required />
                    @error('name')
